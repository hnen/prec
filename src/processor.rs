...
fn test_evaluate_defines() {
    ...
    //assert_eq!(evaluate_defines(&lexer::tokenize(code).unwrap()[..], &[Define::new("foo", "bar")]),
...
aaa";
    ...
    assert_eq!(result, Ok(vec![Word("xxx".to_string()), Newline,
                               Word("aaa".to_string()), Newline,
                               Word("aaa".to_string()), Newline,
                               Word("yyy".to_string()), Newline,
                               Word("aaa".to_string()), Newline,
                               Word("zzz".to_string()), Newline,
                               Word("aaa".to_string()), Newline,
                               Word("aaa".to_string()), Newline,
                               Word("yyy".to_string()), Newline,
    ]));
